...
PURITY_CALL_TOOL = {
    ...
    "description": (
        ...
        "NEVER use grep, awk, sed, python scripts, or any ad-hoc Bash one-liners "
        "for file searching, editing, or listing. This tool exists to replace them all "
        "with structured, safe, .gitignore-aware operations.\n\n"
