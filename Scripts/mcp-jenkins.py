...
JENKINS_CALL_TOOL = {
    ...
    "description": (
        ...
        "                                              Pagination: start_line (0-based offset, default 0),\n"
        "                                              max_lines (default 1000). Response includes totalLines,\n"
        "                                              hasMore, nextStartLine — use nextStartLine in a follow-up\n"
