...
FORGE_CALL_TOOL = {
	"name": "forge_call",
	"description": (
		"Build and test orchestration via project-forge.yaml. MANDATORY when "
		"`project-forge.yaml` exists in the project: ALL build/test/clean "
		"commands MUST go through this tool instead of Bash.\n\n"
		"When NOT to use:\n"
		"  - Project has no project-forge.yaml -> use mcp-compile or Bash.\n"
		"  - Ad-hoc one-off shell commands -> Bash.\n"
		"  - File search/edit -> mcp-purity. Git -> mcp-git. Code intel -> mcp-clangd/luals.\n\n"
		"Prefer this OVER Bash(\"make ...\"), Bash(\"npm test\"), Bash(\"ctest\"), "
		"Bash(\"cmake --build ...\"), Bash(\"cargo build\"), Bash(\"rm -rf build\") -- "
		"the YAML descriptor defines them once and forge runs them with output "
		"filtering, env override, and auto-build of test prerequisites.\n\n"
