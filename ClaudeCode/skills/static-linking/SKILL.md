...
find_program(VERIFY_STATIC
    ...
    HINTS
        ...
        ${CMAKE_SOURCE_DIR}/../static-linking
        ~/.claude/skills/p/skills/static-linking
)
...
cp ~/.claude/skills/p/skills/cmake/template.cmake CMakeLists.txt

# 2. Build with static linking
python3 ~/.claude/skills/p/skills/static-linking/build-static.py --verify

# 3. Validate CMake patterns
python3 ~/.claude/skills/p/skills/cmake/cmake-validator.py CMakeLists.txt
```
...
- **[p:cmake skill](../cmake/SKILL.md)** - General CMake best practices
