---
name: analyze-api
description: API/interface analysis — documents public APIs, interfaces, and how external code should interact with a module or subsystem. Use to produce API reference documentation.
---
