---
name: analyze-subsystem
description: Subsystem/component analysis — maps how multiple modules interact to form a larger component. Use to document the architecture and interactions of a subsystem.
---
