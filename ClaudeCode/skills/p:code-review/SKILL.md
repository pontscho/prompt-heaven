---
name: p:code-review
description: Review code quality of files or directories via a multi-agent Find→Verify→Synthesize fan-out — one specialized lens finder per angle, an independent verifier per candidate, then a ranked/capped, finding-derived scored report. Use for code quality assessment, refactoring decisions, or learning unfamiliar code. Trigger: /p:code-review <file-or-directory>
---
