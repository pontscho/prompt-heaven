...
```bash
~/.claude/skills/p/skills/cmake/cmake-validator.py CMakeLists.txt
```
...
**For complete static linking guide, see [p:static-linking skill](../static-linking/SKILL.md)**
...
**For complete static linking setup, use [p:static-linking skill](../static-linking/SKILL.md)**
...
```bash
~/.claude/skills/p/skills/static-linking/verify-static-linking.py ./myapp
```
...
See **[p:static-linking skill](../static-linking/SKILL.md)** for automated workflows.
...
**For static linking troubleshooting, see [p:static-linking skill](../static-linking/SKILL.md)**:
- macOS crt0.o error
...
~/.claude/skills/p/skills/static-linking/verify-static-linking.py build/myapp
```
See **[p:static-linking skill](../static-linking/SKILL.md)** for detailed verification workflows.
...
- **[p:static-linking skill](../static-linking/SKILL.md)** - Specialized guide for building and verifying static binaries
...
7. **For static linking**: Use **[p:static-linking skill](../static-linking/SKILL.md)** tools and guides
