...
```bash
python ~/.claude/skills/p:verify/scripts/validate.py path/to/file.json
python ~/.claude/skills/p:verify/scripts/validate.py a.json b.yaml c.toml   # batch
echo '{"a":1}' | python ~/.claude/skills/p:verify/scripts/validate.py --format json -
```
