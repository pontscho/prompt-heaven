---
name: analyze-module
description: Module/file deep analysis — analyzes and documents how a specific file or module works internally (not a code review). Use to understand or explain an existing module.
---
