---
name: analyze
description: Smart code analysis dispatcher — determines the right analysis type (module, subsystem, or API) for a target and performs it. Use when asked to analyze or explain how existing code works.
---
